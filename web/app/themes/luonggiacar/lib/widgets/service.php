...
class LuongWP_Service_Widget extends RepeaterWidget
{
    ...
    {
        parent::__construct( 'luongwp_service_widget',LUONGWP_ABBR. ' - service', [
                        ...
                        <div class="media block-6 services">
                            <div class="media-body py-md-4">
                                <div class="d-flex mb-3 align-items-center">
                                    <div class="icon"><span class="<?php $this->val( $inst, 'icon', $i ); ?>"></span></div>
                                    <h3 class="heading mb-0 pl-3"><?php $this->val( $inst, 'title_service', $i ); ?></h3>
                                </div>
                                <p><?php $this->val( $inst, 'title_service_desc', $i ); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endfor; ?>
